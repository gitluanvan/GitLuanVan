		...
		<div class="thongtincb">
			...
			<?php 
				...
				if (in_array($id_loai, $id_tbamthanh) ) {
					...
					<div class="d_thongtincb" id="select_div">
						<label class="label_thongtincb">Thương Hiệu:</label>
						<select id="tbamthanh" name="thuonghieu">
							<option value="<?=$thuonghieu?>"><?=$thuonghieu?></option>
							<option value="No brand">No brand</option>
			...
			<div class="d_thongtincb">
				<label class="label_thongtincb">Giá:</label><input type="number" name="gia" value="<?=$chitietsanpham->Gia?>" required>
				
			</div>
			<div class="d_thongtincb">
				<label class="label_thongtincb">Kho hàng:</label><input type="number" name="khohang" value="<?=$chitietsanpham->Kho?>" required>
