...
<body>
	...
	<div class="shopnew_content">
		...
		<div class="shopnew_inf">
			<form method="POST">
				<div class="shopnew_div"><label class="label_thongtin">Tên Shop Của Bạn:</label><input type="text" name="tenshop" ></div>
				<div class="shopnew_div"><label class="label_thongtin">Địa Chỉ:</label><textarea name="diachi" ><?=$user->DiaChi?></textarea></div>
