...
// end load danh mục sản phẩm lên menu
	...
	//thêm bình luận
		function insertBinhLuan($noidung, $id_user, $id_sanpham){
			$sql = "INSERT INTO binhluan(NoiDung, id_User, id_SanPham) VALUES (?,?,?)";
			$this->setQuery($sql);
			$result = $this->execute(array($noidung, $id_user, $id_sanpham));
			if($result){
